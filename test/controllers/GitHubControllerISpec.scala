...
class GitHubControllerISpec extends BaseSpecWithApplication {
    ...
    "GitHubController .getGitHubRepo()" should {
        ...
        "return Ok" in {
            ...
            val readResult: Future[Result] = TestGitHubController.getGitHubRepo("Aashvin", "COMP0031-PlantBot")(readRequest)
